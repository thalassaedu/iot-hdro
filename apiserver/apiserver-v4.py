...
# Endpoint to retrieve the last 10 readings for charting
...
def get_historical_data():
    try:
        ...
        # Query to fetch the last 10 sensor data entries
        query = """
        ...
        return jsonify({'message': 'Failed to retrieve data for dashboard', 'error': str(e)}), 500

# Serve the main dashboard page with interactive charts
@app.route('/dashboard')
def dashboard():
